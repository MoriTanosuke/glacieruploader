...
public class GlacierUploaderOptionParser extends OptionParser {
  ...
  private ArgumentAcceptingOptionSpec<String> parseInventory(Configuration config) {
    ...
    }, "retrieve the inventory listing of a vault").withOptionalArg().ofType(String.class);
  }
  ...
  private ArgumentAcceptingOptionSpec<Integer> parsePartSize(Configuration config) {
    ...
    }, "sets the size of each part for multipart uploads").withOptionalArg().ofType(Integer.class).defaultsTo(10485760);
    // 10 MB.
  }
